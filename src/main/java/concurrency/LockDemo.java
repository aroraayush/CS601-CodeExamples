...
/**
 * 	This class demonstrates the impact that DIFFERENT TYPES OF LOCK OBJECTS have,
 *  on whether multiple threads may run synchronized
...
public class LockDemo {
	...
	private final Object multiLock; // Names only for confusion
	...
	public LockDemo(String name) {
		...
		// working with this.getClass()
		// Quiz 8 (totalNumberOfVisits)
//		worker1 = new Worker(this.getClass());
//		worker2 = new Worker(this.getClass());
