...
/**
 * Demonstrates how to use the HttpSession class to keep track of the
 * number of visits for each client and the date of the last visit
 */
...
public class SessionServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		// The servlet container creates session between an HTTP client and an HTTP server.
		// The server can maintain a session in many ways such as using cookies or rewriting URLs.
		HttpSession session = request.getSession();
		// Cookie Name : JSESSIONID
		// Cookie Value : node01uo4pn0qs8kw3zi8y3hl0o3hm0.node0
