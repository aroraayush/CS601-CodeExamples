...
/**
 * SimpleServer ("Echo" Server). Opens a WELCOMING SOCKET, listens for client requests.
 * Once the client asks to connect, creates a new "CONNECTION SOCKET" for the client.
 * Reads messages from the client from the input stream. Prints them to the console.
 */
public class SimpleServer extends Thread {
	...
	// Could have used volatile if multiple threads accessing the variable
